 ...
 */
final class Version20230501071958 extends AbstractMigration
{
...
//       $this->addSql('ALTER TABLE menus DROP categories_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categories CHANGE dish_categorie dish_category VARCHAR(50) NOT NULL');
        $this->addSql('ALTER TABLE menus ADD categories_id INT NOT NULL');
    }
}
